...
namespace Client_Comm_Module
{
    public class ClientCommHandler
    {
        ...
        public int UDPPortReceive { get; set; }
        public int UDPPortSend { get; set; }

        private bool gameStarted;

        public ClientCommHandler()
        {
            receiver = new ClientMessageReceiving(this);
        ...
        {
            gameStarted              = false;
            dataReceiver.gameRunning = false;
            dataSender.gameRunning   = false;
        }
        ...
        */
        ...
        private void initializeDataTransmission()
        {
            if (!gameStarted)
            {
                gameStarted = true;
                if(dataReceiver == null)
                    dataReceiver = new ClientDataReceiving(UDPPortReceive);
                if(dataSender == null)
                    dataSender = new ClientDataTransmission(UDPPortSend);
                dataReceiver.gameRunning = true;
                dataSender.gameRunning = true;
        ...
        {
            if (dataReceiver != null)
                //return (GameFrame)Data_Manipulation.DataControl.bytesToObject((Data_Manipulation.DataControl.objectToBytes(dataReceiver.Data)));
        ...
        public ClientMessageReceiving getReceiverContext()
        {
            return receiver;
        }
    }
