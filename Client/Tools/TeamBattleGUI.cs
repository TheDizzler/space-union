...
namespace SpaceUnionXNA.Tools {
	class TeamBattleGUI : GUI {
        ...
        private int redTeamKillsCount = 0;
        private int blueTeamKillsCount = 0;
		...
		public override void update(GameTime gameTime, QuadTree quadTree) {
			...
			if (teamBattleTime <= TimeSpan.Zero) {
                ...
                foreach (Ship ship in ships)
                {
                    ...
                    {
                        redTeamKillsCount += ship.kills;
                    }
                    if (ship.blueTeam == true)
                    {
                        blueTeamKillsCount += ship.kills;
                    }
                }
            ...
            redTeamKills = redTeamKillsCount;
            blueTeamKills = blueTeamKillsCount;
		}
