...
namespace SpaceUnionXNA.Controllers
{
    ...
    public class GameplayScreen
    {
        ...
        static public int worldWidth = 1500;
        static public int worldHeight = 1000;
        ...
        public GameplayScreen(Game1 game, SpriteBatch batch)
        {
            ...
            if (game.roomInfo != null)
            {
                foreach (var p in game.roomInfo.Players)
                {
                    if (p.Player.Username != game.Player.Username)
                    {
                        ...
                        {
                            case 0:
                                testship = new AlphaShip(this.game, Color.Yellow);
                                break;
                            case 1:
                                testship = new ThetaShip(this.game, Color.Yellow);
                                break;
                            case 2:
                                testship = new OmegaShip(this.game, Color.Yellow);
                                break;
                            default:
                                testship = new ThetaShip(this.game, Color.Yellow);
                                break;
                        ...
                        testship.setUserName(p.Player.Username);
                        ships.Add(testship.getUserName(), testship);
                        Console.WriteLine(testship.getUserName());
                    }
                    else
                    {
            ...
            */
            ...
            background = new Background(worldWidth * 5, worldHeight * 5, Assets.starfield1, Assets.starfield1, Assets.starfield1, Assets.starfield1);
            ...
            playerShip.setUserName(game.Player.Username);
            playerShip.Position = respawnpoints.ElementAt(2);
            ...
            mainCamera = new Camera(mainViewport, worldWidth, worldHeight, 0.75f);
        ...
        {
            //Console.WriteLine(gameData.Angle + " " + gameData.XPosition + " " + gameData.YPosition);
        ...
        public void draw(GameTime gameTime)
        {
            ...
            drawBorder(spriteBatch, new Rectangle(0 - Assets.alpha_ship_texture.Width / 2 - 10, 0 - Assets.alpha_ship_texture.Height / 2 - 10,
                       worldWidth + Assets.alpha_ship_texture.Width + 20, worldHeight + Assets.alpha_ship_texture.Height + 20), 10, Color.White);
            drawShips();
            spriteBatch.End();
