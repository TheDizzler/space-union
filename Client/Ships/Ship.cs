...
namespace SpaceUnionXNA.Ships
{
    ...
    public abstract class Ship : Tangible
    {
        ...
        protected Ship(Texture2D tex, Texture2D wpnTex, Game1 game1, Color tColor)
        ...
        public void setLauncherList(object[] bulletList)
        {
        ...
        {
            sBatch.Draw(texture, position, null, teamColor, rotation, origin, scale, SpriteEffects.None, 0);
